...
def get_missing_value_percentage():
    ...
    try:
        ...
        if column_name not in metadata.column_list and metadata.deleted_column_list.get(column_name,None) == None and column_name != "All Columns" and get_all_columns == False :
        ...
        if get_all_columns == False and column_name != "All Columns":
            ...
            cols = list(metadata.deleted_column_list.keys())
    
        # Get the percentage of missing values in each column
        missing_value_data = []
        for col in cols:
            missing_percentage = 0
            is_column_deleted = metadata.deleted_column_list.get(col,False)   
        ...
        if column_name != "All Columns":
            ...
            if imputation_method == "drop_rows" or imputation_method == "drop_column":
                ...
                # Drop entire column   
                    ...
                    metadata["deleted_column_list"][column_name] = True
            ...
            if imputation_method == "drop_rows" or imputation_method == "drop_column":
                ...
                # Drop entire column   
                    ...
                    for column in columns_with_missing_value:
                        metadata["deleted_column_list"][column] = True
